...
class RedSpiderForge:
    ...
    def __init__(self, master):
        ...
        self.artefact_types = ["Python Script (.py)", "Configuration File (.ini)", "Log File (.log)", "Text Document (.txt)", "Batch Script (.bat)", "Executable (.exe)"]
        
        # Themes are now TEMPLATE FILENAMES
        self.content_themes = ["KEYLOGGER (PY)", "FULL RAT", "MALWARE", "SPAM (BAT)"] 
